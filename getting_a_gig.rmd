...
tree$convert.Pred.Class <- ifelse(tree$convert.Pred > quantile(tree$convert.Pred, probs = 0.5), "Above 50%", "Below")
table(tree$convert.Pred.Class)

#For training set
print("Train set")
table(TrueConvert = tree$convert.Pred.Class[train], PredConvert = tree$convert.Pred.Class[train]) #How many instances were misclassified? Error rates?
#For test set
print("Test set")
table(TrueConvert = tree$convert.Pred.Class[test], PredConvert = tree$convert.Pred.Class[test]) #How many instances were misclassified? Error rates?
